    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 dark:bg-gray-900 dark:bg-gradient-to-b dark:from-gray-900 dark:to-gray-800">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-r from-gray-900/90 to-gray-900/50 dark:from-gray-900/95 dark:to-gray-900/70" />
        </div>
            ...
            <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-blue-500">Through Statistics</span>
                </h1>
                <p className="mt-3 text-base text-gray-300 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                  Explore your favorite artists, discover new music, and dive deep into music statistics with our comprehensive analytics platform.
                </p>
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  ...
                  <div className="mt-3 sm:mt-0 sm:ml-3">
                    <Link
                      to="/charts"
                      className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-blue-600 bg-blue-100 hover:bg-blue-200 dark:text-white dark:bg-blue-900 dark:hover:bg-blue-800 md:py-4 md:text-lg md:px-10"
                    >
                      View Charts
                    </Link>
                  </div>
